...
This course is designed to give students a range of conceptual and technical tools. By the end, students should be able to:

- Operate and manipulate distinct kinds of data (numbers, text, etc.).
- Implement and interpret advanced machine learning methods.
- Connect social science questions to an analytical perspective.

Lectures can be found on GitHub: https://github.com/seantrott/css100_lectures 
